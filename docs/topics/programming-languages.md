...
| 61 | Reference | הפניה | משתנה המצביע על משתנה אחר (בשxxxxxxxxxxxxxxxxxx מסוימות). |
...
| 65 | Thread | תהליך משנה | יחידת ביצוע בתוך תוכנית המאפשרת ריבוי משימות. |
...
| 91 | Graph | גרף | מבנה נתונים המורכב מצמתים וקשתות המקשרות ביניהם. |
...
| 150 | Promise | הבטחה | מבנה המייצג פעולה אסינכרונית בשxxxxxxxxxxxxxxxxxx תכנות. |
...
| 190 | IDS (Intrusion Detection System) | מערכת גילוי חדירות | מערכת המזהה התקxxxxxxxxxxxxxxxxxx על רשת או מערכת. |
| 191 | IPS (Intrusion Prevention System) | מערכת מניעת חדירות | מערכת החוסמת התקxxxxxxxxxxxxxxxxxx בזמן אמת. |
