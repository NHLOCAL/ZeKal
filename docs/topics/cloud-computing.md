...
| 9 | Scalability | מדרגיות | היכולת להגדיל או להקטין משאבים לפי הצורך ללא פגיעה בביצועים. |
...
| 33 | Compliance | תאימות | התאמת המערכת לדרישות חוקיות ותקנים. |
...
| 90 | Penetration Testing | בדיקת חדירות | בדיקה לאיתור חולשות אבטחה. |
...
| 114 | Hadoop | Hadoop | אקוסיסטם לעיבוד ואחסון נתונים גדולים מבוזרים. |
