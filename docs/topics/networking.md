...
| 137 | Network Sniffer | מרחרח רשת | כלי המאפשר לכידה וניתוח של תעבורת רשת. |
...
| 143 | Intrusion Prevention System (IPS) | מערכת מניעת חדירות | מערכת המונעת פעילויות חשודות או התקפות. |
...
| 183 | Micro-Segmentation | מיקרו-חלוקה | חלוקה עדינה של רשתות וירטואליות להגבלת תנועת התקפות. |
