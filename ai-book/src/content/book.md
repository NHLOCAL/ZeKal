...
הדימוי הקלאסי כאן הוא אילוף של חיית מחמד. הכלב הוא ה**סוכן**, הבית או הפארק הם ה**סביבה**. הוא יכול לבצע **פעולות** שונות (לשבת, להביא כדור, לנבוח). כאשר הוא מבצע פעולה רצויה (למשל, יושב כשמבקשים ממנו) ב**מצב** מסוים, הוא מקבל **תגמול** (חטיף, ליטוף). כשהוא מבצע פעולה לא רצויה, הוא עשוי לא לקבל תגמול או לקבל "עונש" קל (כמו נזיפה). לאט לאט, מתוך ניסוי וטעייה וקבלת הפידבק הזה, הכלב לומד איזו התנהגות "משתלמת" יותר בטווח הארוך.
...
*   **תגמול (Reward):** הפידבק (חיובי או שלילי) שהסוכן מקבל מהסביבה לאחר ביצוע הפעולה.
...
*   **מתי להשתמש?** למידת חיזוק היא הגישה המועדפת **כאשר אנו רוצים לאמן מערכת לקבל רצף של החלטות בסביבה דינמית כדי למקסם מטרה ארוכת טווח, והפידבק על הפעולות מגיע בצורת תגמולים.**
...
*   הגנרטור מקבל פידבק מהמבחין (עד כמה הוא הצליח "לעבוד" עליו) ומשתמש בפידבק הזה כדי להשתפר ביצירת תמונות מזויפות שנראות יותר ויותר אמיתיות.
